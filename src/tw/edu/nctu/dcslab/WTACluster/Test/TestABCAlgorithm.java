...
public class TestABCAlgorithm {
	...
	public static void main( String args[] ) {
		...
		ABCAlgorithm abc = new ABCAlgorithm(problem, 100);

		System.out.println("Start ABC Test");
		...
		for( int i=0; i<iterationRound; i++ ) {
			...
			if ( bestValue > problem.fitnessFunction(abc.getBestSolution()) ) {
				double tmp = problem.fitnessFunction(abc.getBestSolution());
